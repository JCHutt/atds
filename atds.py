...
A collection of data types including: Stacks, Queues, Deques, Nodes, Trees, Heaps, etc.
"""
...
def main():
    ...
    if bh.__repr__() == "BinaryHeap[0, 1, 2, 5, 4, 3, 8, 7, 15, 20, 41, 32, 9]": # Mine doesn't match this one (it has the 7 and 8 flipped) but it is still a valid minheap
        tests_passed += 1
